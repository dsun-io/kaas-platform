...
function AuditFilters({
  ...
  filters: { action: string; resource_type: string; since: string; until: string };
  onChange: (k: string, v: string) => void;
  onReset: () => void;
}) {
  const hasFilters = filters.action || filters.resource_type || filters.since || filters.until;
  ...
  return (
    <>
      ...
      >
        ...
        <TableCell className="font-mono text-xs">{entry.resource_id}</TableCell>
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead className="text-xs">资源 ID</TableHead>
